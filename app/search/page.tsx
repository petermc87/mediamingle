...
const info =
  "Search will take your query and find the best available match form the live incoming news";
    ...
    <>
      ...
      <main className={styles.homePage}>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Button type="submit" className="mb-3" disabled={isSearching}>
